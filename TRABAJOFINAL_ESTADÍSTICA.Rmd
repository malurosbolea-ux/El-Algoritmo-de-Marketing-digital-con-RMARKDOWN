...
# 1. Introducción: Del **"Olfato"** al Dato
...
## 2.1. Generación del Dataset **Marketing_2025**
...
## 2.2. Preprocesamiento y Control de Calidad
...
## 3.1. Análisis Univariante: La Distribución de la Inversión
...
## 3.2. Análisis Bivariante: Rendimiento por Canal
...
- **TikTok (Rosa claro):** Fijaos en los puntos rojos (outliers) en la parte superior. TikTok tiene una media baja, pero una capacidad de "pelotazo" viral que no tienen las otras. Es una apuesta de riesgo.
- **Instagram:** Se queda en tierra de nadie. Estable, pero con menor rendimiento que LinkedIn en este escenario B2B/B2C mixto.
</div>

## 3.3. Análisis Multivariante: El ROI (Relación Presupuesto-Ventas)
...
## 4.1. Contraste de Hipótesis (ANOVA)
